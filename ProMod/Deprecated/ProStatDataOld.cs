...
//        public Dictionary<SaberType, int> MaxGoodCutScoreBySaber = new Dictionary<SaberType, int>();

//        public Dictionary<SaberType, int> ComboDamageBySaber = new Dictionary<SaberType, int>();
//        public Dictionary<SaberType, int> MissDamageBySaber = new Dictionary<SaberType, int>();
//        public Dictionary<SaberType, int> BadCutDamageBySaber = new Dictionary<SaberType, int>();

//        public int score;
//        public int maxCurrentScore;
//        public int maxBeatmapScore;
//        public int maxGoodCutScore;
...
//        public int badCutDamage;

//        public float songTime;
//        public float songLength;

//        public int beatmapNoteCount;
//        public int scoredNoteCount;
...
//        public int maxLives;
//        public bool failed;
//        public float acc => (maxCurrentScore > 0) ? (float)score / (float)maxCurrentScore : 1.0f;

//        public int nonAccDamage => comboDamage + missDamage + badCutDamage;
//        public bool fullCombo => maxCombo == combo && nonAccDamage == 0;
//        public float fullComboAcc {
//            get
//            {
//                if(maxGoodCutScore > 0)
//                {
//                    return (float)(score + comboDamage) / (float)maxGoodCutScore;
//                } else if (maxCurrentScore > 0)
//                {
//                    return 0f;
//                } else
//                {
...
//        public float SaberAcc(SaberType saber){

//            if (MaxGoodCutScoreBySaber[saber] > 0) {
//                return (float)(CurrentScoreBySaber[saber] + ComboDamageBySaber[saber]) / (float)MaxGoodCutScoreBySaber[saber];
//            } else if (MaxCurrentScoreBySaber[saber] > 0)
//            {
//                return 0.0f;
//            } else
//            {
...
//                MaxGoodCutScoreBySaber.Add(saberType, 0);

//                ComboDamageBySaber.Add(saberType, 0);
//                MissDamageBySaber.Add(saberType, 0);
//                BadCutDamageBySaber.Add(saberType, 0);
